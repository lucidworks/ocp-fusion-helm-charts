...
*/}}
{{- define "fusion.rest-service.name" -}}
...
*/}}
{{- define "fusion.rest-service.fullname" -}}
...
*/}}
{{- define "fusion.rest-service.pulsarServiceUrl" -}}
...
*/}}
{{- define "fusion.rest-service.kubeNamespace" -}}
...
*/}}
{{- define "fusion.rest-service.serviceName" -}}
{{ .Values.serviceName }}
{{- end -}}
...
*/}}
{{- define "fusion.rest-service.chart" -}}
...
*/}}
{{- define "fusion.rest-service.labels" -}}
helm.sh/chart: "{{ include "fusion.rest-service.chart" . }}"
app.kubernetes.io/name: "{{ template "fusion.rest-service.name" . }}"
