...
*/}}
{{- define "fusion.classic-rest-service.name" -}}
...
*/}}
{{- define "fusion.classic-rest-service.fullname" -}}
...
*/}}
{{- define "fusion.classic-rest-service.pulsarServiceUrl" -}}
...
*/}}
{{- define "fusion.classic-rest-service.kubeNamespace" -}}
...
*/}}
{{- define "fusion.classic-rest-service.serviceName" -}}
{{ .Values.serviceName }}
{{- end -}}
...
*/}}
{{- define "fusion.classic-rest-service.chart" -}}
...
*/}}
{{- define "fusion.classic-rest-service.labels" -}}
helm.sh/chart: "{{ include "fusion.classic-rest-service.chart" . }}"
app.kubernetes.io/name: "{{ template "fusion.classic-rest-service.name" . }}"
