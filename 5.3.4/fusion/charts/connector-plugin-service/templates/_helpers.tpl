...
*/}}
{{- define "fusion.connector-plugin-service.name" -}}
...
*/}}
{{- define "fusion.connector-plugin-service.fullname" -}}
...
*/}}
{{- define "fusion.connector-plugin-service.serviceName" -}}
{{ .Values.serviceName }}
{{- end -}}
...
*/}}
{{- define "fusion.connector-plugin-service.pulsarServiceUrl" -}}
...
*/}}
{{- define "fusion.connector-plugin-service.pulsarAdminUrl" -}}
{{- $tlsEnabled := ( eq ( include "fusion.tls.enabled" . ) "true" ) }}
{{- if .Values.global -}}
...
*/}}
{{- define "fusion.connector-plugin-service.kubeNamespace" -}}
...
*/}}
{{- define "fusion.connector-plugin-service.chart" -}}
...
*/}}
{{- define "fusion.connector-plugin-service.labels" -}}
helm.sh/chart: "{{ include "fusion.connector-plugin-service.chart" . }}"
app.kubernetes.io/name: "{{ template "fusion.connector-plugin-service.name" . }}"
