...
{{- if and (include "kafka.tlsEncryption" .) (eq .Values.auth.tls.type "jks") (empty .Values.auth.tls.existingSecrets) (not ( include "fusion.tls.enabled" $ )) }}
...
{{- else if and (include "kafka.tlsEncryption" .) (eq .Values.auth.tls.type "pem") (empty .Values.auth.tls.existingSecrets) (not .Values.auth.tls.autoGenerated) (not ( include "fusion.tls.enabled" $ )) }}
kafka: auth.tls.existingSecrets
