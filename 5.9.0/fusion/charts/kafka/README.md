...
| `zookeeperChrootPath`                      | Path which puts data under some path in the global ZooKeeper namespace                                                                                                              | `"/kafka"`                                |
...
| `metrics.kafka.serivce.enabled`                             | Whether or not to create a service for Kafka exporter deployment                                                                 | `false`                                                                                 |
...
NOTE: bitnami common helm chart was removed and all the required references were added to the helpers.tpl file
